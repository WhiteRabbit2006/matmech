...
SOFTWARE_PROFILES: Dict[str, Dict[str, Any]] = {
    "wavematrix": {
        ...
        "remove_turnaround_artifacts": True,  # Default to cleansing turnaround spikes
    },
    "bluehill": {
        ...
        "column_sources": {
            ...
            "axial_strain": [
                {"raw_col": "ave2", "raw_units": "unitless"},
                {"raw_col": "Strain", "raw_units": "unitless"},
                {"raw_col": "Strain (%)", "raw_units": "percent"},
            ],
        },
        "inversion_flags": {"force": False, "torque": False},
        "remove_turnaround_artifacts": True,  # Default to cleansing turnaround spikes
...
DEFAULT_PLOTS: Dict[str, Dict[str, Any]] = {
    ...
    "time_position_static": {
        ...
        "output_filename": "position_time_static",
        "phases": ["*"],
        "type": "static",
    },
    "time_position_animated": {
        ...
        "output_filename": "position_time_animated",
        "phases": ["*"],
        "type": "animated",
    },
    "force_position_static": {
        ...
        "output_filename": "force_pos_static",
        "phases": ["*"],
        "type": "static",
    },
    "force_displacement_static": {
        ...
        "output_filename": "force_disp_static",
        "phases": ["*"],
        "type": "static",
    },
    "force_position_animated": {
        ...
        "output_filename": "force_pos_animated",
        "phases": ["*"],
        "type": "animated",
    },
    "time_force_static": {
        ...
        "output_filename": "force_time_static",
        "phases": ["*"],
        "type": "static",
    },
    "time_stress_static": {
        ...
        "output_filename": "stress_time_static",
        "phases": ["*"],
        "type": "static",
    },
    "time_strain_static": {
        ...
        "output_filename": "strain_time_static",
        "phases": ["*"],
        "type": "static",
    },
    "stress_strain_static": {
        ...
        "output_filename": "stress_strain_static",
        "phases": ["*"],
        "type": "static",
        "fit_line": True,
    },
    "stress_strain_animated": {
        ...
        "output_filename": "stress_strain_animated",
        "phases": ["*"],
        "type": "animated",
    },
    # Torsional Plots
    "time_rotation_static": {
        ...
        "output_filename": "rotation_time_static",
        "phases": ["*"],
        "type": "static",
    },
    "time_rotation_animated": {
        ...
        "output_filename": "rotation_time_animated",
        "phases": ["*"],
        "type": "animated",
    },
    "torque_rotation_static": {
        ...
        "output_filename": "torque_rotation_static",
        "phases": ["*"],
        "type": "static",
    },
    "torque_rotation_animated": {
        ...
        "output_filename": "torque_rotation_animated",
        "phases": ["*"],
        "type": "animated",
    },
    "shear_stress_shear_strain_static": {
        ...
        "output_filename": "shear_stress_strain_static",
        "phases": ["*"],
        "type": "static",
        "fit_line": True,
    },
    "shear_stress_shear_strain_animated": {
        ...
        "output_filename": "shear_stress_strain_animated",
        "phases": ["*"],
        "type": "animated",
    },
}
